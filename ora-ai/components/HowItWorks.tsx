                  ...
                  {/* Header */}
                        <div className="text-center mb-16">
                                  ...
                                  <h2 className="text-4xl md:text-5xl font-black text-ocean mb-4">
                                              Opérationnel en{" "}
                                              <span className="text-lagoon"> moins de 10 minutes</span>span>
                                  </h2>h2>
                        ...
                        <div key={step.number} className="relative">
                          ...
                          {i < steps.length - 1 && (
                                      ...
                                      <div className="relative z-10 bg-white rounded-2xl p-8 shadow-sm card-hover text-center">
                                                      <div className="text-5xl mb-4">{step.emoji}</div>div>
                                                      <div className="text-lagoon font-black text-lg mb-2">{step.number}</div>div>
                                                      <h3 className="text-ocean font-bold text-xl mb-3">{step.title}</h3>h3>
                                                      <p className="text-ocean/60 leading-relaxed">{step.description}</p>p>
                                      </div>div>
                        </div>div>
                      ))}
                        </div>div>
