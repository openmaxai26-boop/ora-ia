                ...
                <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                  ...
                  {/* Headline */}
                        <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">
                                  ...
                                  <span className="text-lagoon">pour votre entreprise</span>span>
                                  <br />
                                  24h/24
                        </h1>h1>
                  ...
                  {/* Subheadline */}
                        <p className="text-xl md:text-2xl text-white/70 mb-10 max-w-3xl mx-auto leading-relaxed">
                                  Ora AI automatise vos réseaux sociaux, votre service client, votre SEO et vos tâches
                                  administratives — sans compétences techniques, depuis Tahiti ou n&apos;importe quelle île.
                        </p>p>
                  ...
                  {/* Social proof */}
                        <div className="flex flex-wrap justify-center gap-8 text-white/60 text-sm">
                                  <div className="flex items-center gap-2">
                                              <span className="text-lagoon text-2xl font-bold">5</span>span>
                                              <span>agents IA disponibles</span>span>
                                  </div>div>
                                  <div className="w-px h-8 bg-white/20 hidden sm:block" />
                                  <div className="flex items-center gap-2">
                                              <span className="text-lagoon text-2xl font-bold">0</span>span>
                                              <span>compétences techniques requises</span>span>
                                  </div>div>
                                  <div className="w-px h-8 bg-white/20 hidden sm:block" />
                                  <div className="flex items-center gap-2">
                                              <span className="text-lagoon text-2xl font-bold">7j/7</span>span>
                                              <span>fonctionnement automatique</span>span>
                                  </div>div>
                        </div>div>
                </div>div>
