    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-lagoon/20">
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-lagoon/20 px-6 py-4 flex flex-col gap-4">
          ...
          {loggedIn ? (
            <>
              <a href="/dashboard" onClick={() => setOpen(false)} className="text-ocean font-medium">
                Dashboard
              </a>
              <button
                onClick={handleLogout}
            ...
            <>
              <a href="/login" onClick={() => setOpen(false)} className="text-ocean font-medium text-center">
                Connexion
              </a>
              <a
                href="/signup"
