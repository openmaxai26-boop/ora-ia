                  ...
                  {/* Header */}
                        <div className="text-center mb-16">
                                  ...
                                  <h2 className="text-4xl md:text-5xl font-black text-ocean mb-4">
                                              ...
                                              <span className="text-lagoon">prête à travailler pour vous</span>span>
                                  </h2>h2>
                  ...
                  {/* Agents grid */}
                        ...
                        <div
                          ...
                          {/* Agent info */}
                                      ...
                                      <h3 className="text-2xl font-black text-ocean mb-3">Agent {agent.name}</h3>h3>
                                      <p className="text-ocean/60 mb-6 leading-relaxed">{agent.description}</p>p>
                          ...
                          {/* Coming soon card */}
                                  <div className="card-hover bg-ocean/5 border-2 border-dashed border-ocean/20 rounded-2xl p-8 flex flex-col items-center justify-center text-center">
                                              ...
                                              <h3 className="text-xl font-bold text-ocean/50 mb-2">Bientôt disponible</h3>h3>
                                              <p className="text-ocean/40 text-sm">Agent Comptabilité, Agent Tourisme & Réservations...</p>p>
                                  </div>div>
                        </div>div>
                </div>div>
          </section>section>
